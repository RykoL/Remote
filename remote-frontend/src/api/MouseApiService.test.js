...
describe("MouseApiService", () => {
    ...
    describe("submitMouseMove", () => {
        test("should throw if the request wasn't successfull", async () => {
            ...
            await expect(submitMouseMove(0, 0)).rejects.toEqual("Error when submitting move request Wrong input");
        });
    ...
    describe("submitScroll", () => {
        test("should throw if the request wasn't successfull", async () => {
            ...
            await expect(submitScroll(0, "")).rejects.toEqual("Error when submitting scroll request Wrong input");
        });
    ...
    describe("submitMouseClick", () => {
        test("should throw if the request wasn't successfull", async () => {
            ...
            await expect(submitMouseClick()).rejects.toEqual("Error when submitting click request Wrong input");
        });
