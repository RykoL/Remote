const { MouseMoveHandler } = require("./mouseMoveHandler");
...
describe("MouseMoveHandler", () => {
    ...
    it("should return true when there is one touch", () => {
        ...
        const evt = new TouchEvent('touchstart', {touches: [new Object()]});
    ...
    it("should send mouse move to backend when touch is removed", async () => {
        ...
        const p1 = new TouchEvent('touchstart', {touches: [makeTouch(300, 400, 1)]});
        const p2 = new TouchEvent('touchend', {changedTouches: [makeTouch(400, 700, 1)]});
